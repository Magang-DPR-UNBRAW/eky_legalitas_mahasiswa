...
use App\Http\Controllers\MahasiswaController; // MahasiswaController sudah di-import
...
// Routes dengan middleware auth (hanya bisa diakses jika sudah login)
...
Route::resource('mahasiswa', App\Http\Controllers\MahasiswaController::class);
    ...
    /*
      Route di atas akan secara otomatis membuat route berikut:
      - GET       /mahasiswa           -> MahasiswaController@index (untuk menampilkan daftar mahasiswa)
      - GET       /mahasiswa/create    -> MahasiswaController@create (untuk menampilkan form tambah mahasiswa)
      - POST      /mahasiswa           -> MahasiswaController@store (untuk menyimpan data mahasiswa baru)
      - GET       /mahasiswa/{id}      -> MahasiswaController@show (untuk menampilkan detail mahasiswa)
      - GET       /mahasiswa/{id}/edit -> MahasiswaController@edit (untuk menampilkan form edit mahasiswa)
      - PUT/PATCH /mahasiswa/{id}      -> MahasiswaController@update (untuk memperbarui data mahasiswa)
      - DELETE    /mahasiswa/{id}      -> MahasiswaController@destroy (untuk menghapus data mahasiswa)
    */
});
...
// Tambahkan referensi lainnya sesuai dengan yang Anda butuhkan...
